...
const flowSecundario = addKeyword(['eso es todo gracias', 'chau','hasta luego', 'adios']).addAnswer(['¡Gracias por visitarnos!', '¿Puedo ayudarte en algo más?']);

const flowHerramientas = addKeyword(['herramientas', 'herra', "her"])
...
const flowMateriales = addKeyword(['materiales', 'mate',"mat"])
...
const flowPinturas = addKeyword(['pinturas', 'pintu',"pin"])
...
const flowOtros = addKeyword(['otros', 'otro',"ot"])
...
const flowTipoProducto = addKeyword(['buscar producto', 'producto',"prod","buscar"])
...
const flowAyuda = addKeyword(['ayuda', 'ayu'])
  ...
  .addAnswer(
    ...
    [
      ...
      addKeyword(["Pagina web",'pagina','pag']).addAnswer('Puedes acceder a nuestra pagina web con el siguiente enlace:\n https://eilmer2.github.io/Politicas/'),
...
const flowPrincipal = addKeyword(['hola', 'ola','ole','buenas','wenas', 'ferretería'])
